...
unsigned char dummy_send_irq(unsigned char first_byte)
{
    return 0x00;
}

unsigned char dummy_enable_tx_irq(void)
{
return 0x00;
}

unsigned char dummy_receive_irq(void)
{
return 0x00;
}

unsigned char dummy_cancel_receive_irq(void)
{
return 0x00;
}
...
unsigned char dummy_receive_dma(unsigned char *data,unsigned short int length)
{
return 0x00;
}

unsigned char dummy_cancel_receive_dma(void)
{
return 0x00;
}
...
/* dma callbacks */
unsigned char dummy_dma_send_cb(void *data)
{
return 0x00;
}

unsigned char dummy_dma_receive_cb(void *data)
{
return 0x00;
}
...
comm_error comm_receive(TComm *dev,unsigned char *data,unsigned short int *length,unsigned long int timeout_us)
{
comm_error error;
...
else if(dev->irq_send_cb(dev->data,byte))// send the byte in the buffer, not the one returned by the function
{
