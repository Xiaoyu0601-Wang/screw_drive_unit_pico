...
/* DMA functions */
unsigned char dummy_send_dma(unsigned char *data, unsigned short int length) { return 0x00; }

unsigned char dummy_receive_dma(unsigned char *data, unsigned short int length) { return 0x00; }

unsigned char dummy_cancel_receive_dma(void) { return 0x00; }

/* irq callbacks */
unsigned char dummy_irq_send_cb(void *data, unsigned char *byte) { return 0x01; }

unsigned char dummy_irq_receive_cb(void *data, unsigned char byte) { return 0x01; }
